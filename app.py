...
if run:
    ...
    # — Prüfen, ob Bodentyp bekannt ist —
    if bg is None:
        st.error(
            f"🚫 Ungültige Bodenart '{bodentyp}'.\n\n"
            "Bitte überprüfe deine Eingabedaten oder ergänze den Bodentyp in der bodentyp_to_bg-Zuordnung."
        )
        st.stop()
